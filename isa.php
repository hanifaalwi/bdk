...
join detail_tourism on angkot.id=detail_tourism.id_angkot
join tourism on detail_tourism.id_tourism=tourism.id
join tourism_type on tourism_type.id=tourism.id_type where tourism_type.id in ($c) group by id";
